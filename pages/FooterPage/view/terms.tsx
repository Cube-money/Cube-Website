    ...
    <div className="pt-24 sm:pt-48 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-black space-y-8 text-left" style={{ fontFamily: 'Inter, sans-serif' }}>
          <section>
            <h2 className="text-2xl font-bold mb-4">Agreement to These Terms</h2>
            <p className="text-base leading-relaxed text-gray-800">
              By accessing or using the Services, you agree to be bound by these Terms and Conditions ("Terms"). If you do not agree to these Terms, you must not use the Services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-base leading-relaxed text-gray-800">
              You must be at least 18 years old (or the age of majority in your jurisdiction) to use the Services. You agree to provide accurate, complete, and current information when using the Services.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4">Accounts and Security</h2>
            <p className="text-base leading-relaxed text-gray-800 mb-3">You are responsible for:</p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">Savings Circles, Roles, and Transparency</h2>
            
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold mb-3">A. Organizer Responsibilities</h3>
                <p className="text-gray-800 mb-3">
                  Organizers create savings circles and set rules such as contribution amounts, frequency, payout order, and internal expectations. Organizers are responsible for:
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-800">
                  <li>Inviting members they trust</li>
                  <li>Establishing clear rules and timelines</li>
                  <li>Communicating schedule changes to reduce confusion</li>
                </ul>
              </div>

              <div>
                <h3 className="text-lg font-semibold mb-3">B. Member Responsibilities</h3>
                <p className="text-gray-800 mb-3">Members agree to:</p>
                <ul className="list-disc list-inside space-y-2 text-gray-800">
                  <li>Follow the circle's schedule and rules</li>
                  <li>Make contributions on time according to the agreed terms</li>
                  <li>Communicate promptly if issues arise</li>
                </ul>
              </div>

              <div>
                <h3 className="text-lg font-semibold mb-3">C. Visibility Within a Circle</h3>
                <p className="text-gray-800">
                  To support accountability, members may view contribution and payout statuses within their circle. You should not join a circle if you are not comfortable with this level of transparency.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-base leading-relaxed text-gray-800 mb-3">You agree not to:</p>
            <ul className="list-disc list-inside space-y-2 text-gray-800">
              <li>Use the Services for illegal activity, fraud, or money laundering</li>
              <li>Impersonate others or provide false or misleading information</li>
              <li>Harass, threaten, or exploit other users</li>
              <li>Attempt to disrupt, reverse engineer, or interfere with the Services</li>
              <li>Use the Services to operate circles that violate applicable laws or third-party rights</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-800">
              ...
              <li>You have violated these Terms or applicable circle rules</li>
              <li>Action is required for legal, compliance, or risk management reasons</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">Dispute Resolution, Arbitration, and Class Action Waiver</h2>
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-3">B. Arbitration (If Permitted)</h3>
                <p className="text-gray-800">
                  Except for disputes involving third-party payment services or financial institutions, which must be resolved directly with those providers, disputes arising from use of the Services will be resolved through binding arbitration rather than court, unless eligible for small claims court.
                </p>
              </div>
          ...
          <section>
            ...
            <p className="text-base leading-relaxed text-gray-800">
              These Terms are governed by the laws of the State of Delaware, without regard to conflict-of-law principles, except where applicable consumer protection laws require otherwise.
            </p>
          </section>
