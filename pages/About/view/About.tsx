...
export default function About() {
  ...
  return (
    ...
    >
      ...
      >
        <source src="/AboutUs/AboutUsHero.mp4" type="video/mp4" />
      </video>
      ...
      >
        ...
        >
          Cube is building a new way to pay: community-powered saving that creates real buying power. No debt, no interest, just a reliable path to the lump sum you need.
        </span>
